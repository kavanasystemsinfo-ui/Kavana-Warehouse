// =============================================================================
// Asistente técnico de KAVANA WAREHOUSE (RAG sobre la documentación real del repo)
// - Indexa en memoria README, DECISIONS, ADRs, docs técnicos y de despliegue.
...
async function llamarOpenRouter(apiKey, model, systemPrompt, userPrompt) {
  const res = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'HTTP-Referer': 'https://warehouse.kavanasystems.com',
      'X-Title': 'KAVANA Warehouse Assistant',
    },
    body: JSON.stringify({
      model,
      messages: [
